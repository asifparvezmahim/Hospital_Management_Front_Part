...
const docDetails = (doctor) => {
  ...
  <div class="doctor-image">
    ...
    return `<h4>${item}</h4>`;
        ...
        <p class="w-50">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aut nam eum perspiciatis et, eius ipsa cumque. Rerum iste sunt perspiciatis.</p>
...
const loadPatientId = () => {
  ...
  fetch(`https://testing-8az5.onrender.com/patient/list/?user_id=${user_id}`)
    ...
    .then((data) => {
      ...
      // console.log("Patient ID -> ",data[0].id);
    });
};
